...
import static net.w.fabrichammers.util.reach.ReachDistanceHelper.getReachDistance;
...
public interface BlockFinder {
    ...
    default List<BlockPos> findPositions(World world, PlayerEntity playerEntity, int radius, int depth) {
        ...
        if (blockHitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (item instanceof AoeTool) {
                origin = ((AoeTool) item).getCenterPosition(world, playerEntity, blockHitResult, handStack);
            }
